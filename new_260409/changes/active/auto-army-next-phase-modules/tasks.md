...
- [x] 创建 active change：`auto-army-next-phase-modules`
- [x] 编写并完善 proposal（背景、目标、范围、验收）
- [x] 新增项目路线图文档：`docs/project/next-phase-modules.md`
- [x] 更新文档中心导航：`docs/SKILL.md`
- [x] 重新生成 `SKILL.index.json`
- [x] 更新 verification 记录
