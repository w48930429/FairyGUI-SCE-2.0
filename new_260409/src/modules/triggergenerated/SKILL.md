---
name: triggergenerated
title: "new_260409 TriggerGenerated 模块"
tags: ["module", "triggergenerated", "domain"]
---
...
- **项目**：new_260409
- **模块名**：TriggerGenerated
- **路径**：src/modules/triggergenerated

## 主要职责

- 承载 TriggerGenerated 相关业务能力
- 衔接项目级设计与当前模块实现
- 维护模块边界、依赖与测试要求

## API 文档

- TriggerGenerated module api: [docs/api/module-triggergenerated.md](docs/api/module-triggergenerated.md)
...
- 单元测试：覆盖 TriggerGenerated 模块核心业务规则和边界分支
